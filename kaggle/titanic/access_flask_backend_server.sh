...
# run Basic interview training sequence
echo "Run basic interview training sequence"
curl -X POST -H "Content-Type: application/json" -d '{"n": 12}' http://localhost:5000/interview-train
